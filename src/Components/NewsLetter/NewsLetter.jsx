...
export default function NewsLetter() {
    return (
        <section class="flex mt-28 flex-col max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 md:flex-row md:h-48">
            <div class="md:flex md:items-center md:justify-center md:w-1/2 md:bg-gray-700 md:dark:bg-gray-800">
                <div class="px-6 py-6 md:px-8 md:py-0">
                    <h2 class="text-lg font-bold text-gray-700 dark:text-white md:text-gray-100">Sign Up For Our Newsletter</h2>

                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 md:text-gray-400">Stay up to date with what's happening in our pharmacy</p>
                </div>
            </div>
